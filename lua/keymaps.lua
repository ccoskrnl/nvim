...
-------------------- Funcs -------------------------------
keymap('n', '<LEADER>h', ':lua ShowMyNvimHelp()<ENTER>', opts)
...
keymap('n', '<LEADER>s', ':Symbols<CR>', opts)
keymap('n', '<LEADER>S', ':SymbolsClose<CR>', opts)
...
keymap('n', '<LEADER>cf', ':FloatermNew --height=0.8 --width=0.8 --wintype=float --name=floaterm1 --position=center<CR>', opts)
